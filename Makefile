# This Makefile is for the App::cpansearch extension to perl.
#
...
#     DISTNAME => q[App-cpansearch]
#     LICENSE => q[perl]
#     NAME => q[App::cpansearch]
#     NO_META => q[1]
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.42] }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/App/cpansearch.pm]
...
MAKE = make
FULLEXT = App/cpansearch
BASEEXT = cpansearch
PARENT_NAME = App
DLBASE = $(BASEEXT)
VERSION_FROM = lib/App/cpansearch.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/App/cpansearch.pm
...
TO_INST_PM = lib/App/cpansearch.pm

PM_TO_BLIB = lib/App/cpansearch.pm \
	blib/lib/App/cpansearch.pm
...
DISTNAME = App-cpansearch
DISTVNAME = App-cpansearch-0.01
...
manifypods : pure_all  \
	lib/App/cpansearch.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/App/cpansearch.pm $(INST_MAN3DIR)/App::cpansearch.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/App/cpansearch.pm blib/lib/App/cpansearch.pm 
